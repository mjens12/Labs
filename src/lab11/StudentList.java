...
public class StudentList {
	...
	public static void main(String[] args) {
		...
		System.out.println(
				"Friends, sorted by phone number\n" + friends);

		Collections.sort(friends, new Comparator<Student>() {

			/*
			 * TODO 3a: Complete this an inner class to sort by phone
			 * number.
			 */
		 ...
		 * Code goes just below here
		 */
		Collections.sort(friends, (o1, o2) -> o1.getLastName()
				.compareTo(o2.getLastName()));
		 ...
		 */
		Collections.sort(friends,
				(o1, o2) -> o1.getPhone().compareTo(o2.getPhone()));
		System.out.println("Friends, sorted by last name\n" + friends);
		 ...
		 * code.
		 */
		ArrayList<Student> lista = (ArrayList<Student>) friends
				.stream()
		 ...
		 */
		ArrayList<Student> listb = (ArrayList<Student>) friends
				.stream().filter(arg -> arg.getPhone().contains("610"))
				.collect(Collectors.toList());
		 ...
		 */
		ArrayList<Student> listc = (ArrayList<Student>) friends
				.stream().filter(e -> e.getFirstName().contains("n"))
				.map(arg -> {
		...
		System.out.println("Friends, names in caps " + friends);
		...
		System.out
				.println("Friends, sorted by first name\n" + friends);
	}
}
